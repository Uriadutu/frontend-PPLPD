...
const DatadiriPelatihOnly = () => {
  ...
  const idAtlet = user && user.id_pelatih;
  ...
  return (
    <div className="p-3 mt-5" style={{ background: "#e7e7e7" }}>
      <h1 className="title mt-5">Data Pelatih</h1>
...
export default DatadiriPelatihOnly;
