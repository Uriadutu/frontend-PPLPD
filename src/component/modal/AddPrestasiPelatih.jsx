...
const AddPrestasiPelatih = ({ Muncul, TidakMuncul }) => {
    ...
    useEffect(()=>{
     ...
     const savePrestasi = async () => {
        try {
            await axios.post(`http://localhost:5000/prestasi/pelatih/`, {
        ...
        <div className="modal-background">
          <div className="modal-card">
            <header className="modal-card-head">
              <p className="modal-card-title">Tambah Prestasi Pelatih</p>
              <button
                className="delete"
                aria-label="close"
                onClick={() => {
                ...
                <div className="box is-flex columns is-justify-content-space-between">
                  <div className="komp">
                    ...
                    <div className="field">
                      ...
                      <div className="control">
                        <select value={tingkat} className='select'
...
export default AddPrestasiPelatih
