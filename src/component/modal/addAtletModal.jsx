...
const AddAtletModal = ({ Muncul, tidakMuncul }) => {
  ...
  const saveAtlet = async (e) => {
    ...
    // formData.append("pekerjaan_wali", setPekerjaanWali);
    ...
    // //prestasi
    // formData.append("nama_club", NamaClub);
    // formData.append("nama_event", NamaEvent);
    // formData.append("tahun_prestasi", TahunPrestasi);
    ...
    try {
      ...
      await axios.post("http://localhost:5000/atlet", {
        ...
        nama_akhir: NamaBelakang,
        nama_panggil: NamaPanggilan,
        tgl_lahir: TglLahiratlet,
        tmp_lahir: TempatLahiratlet,
        agama: AgamaAtlet,
        nama_jalan: NamaJalanAtlet,
        desa: DesaAtlet,
        kelurahan: KelurahanAtlet,
        kecamatan: KecamatanAtlet,
        kota: KotaAtlet,
        provinsi: ProvinsiAtlet,
        no_telp: NotelpAtlet,
        hp_mobile: NohpAtlet,
        email: EmailAtlet,
        kelamin: JenisKelaminAtlet,
        gol_darah: GolonganDarahAtlet,
        tinggi_badan: TinggiBadanAtlet,
        berat_badan: BeratBadanAtlet,
        ...
        tahun_daftar: TahunGabungAtlet,

        nama_ayah: NamaAyah,
        tmpLahir_ayah: TempatLahirAyah,
        tglLahir_ayah: TglLahirAyah,
        agama_ayah: AgamaAyah,
        pekerjaan_ayah: PekerjaanAyah,
        noHp_ayah: NohpAyah,
        notlp_ayah: NotelpAyah,
        email_ayah: EmailAyah,

        nama_ibu: NamaIbu,
        tmpLahir_ibu: TempatLahirIbu,
        ...
        desa_ortu: DesaOrtu,
        namaJalan_ortu: NamaJalanOrtu,
        //wali
        nama_wali: NamaWali,
        hubkeluarga_wali: HubKeluargaWali,
        tempLahir_wali: TempatLahirWali,
        tglLahir_wali: TglLahirWali,
        agama_wali: AgamaWali,
        jeniskelamin_wali: JenisKelaminWali,
        pekerjaan_wali: PekerjaanWali,
        noHp_wali: NohpWali,
        notlp_wali: NotelpWali,
        email_wali: EmailWali,
        provinsi_wali: ProvinsiWali,
        kota_wali: KotaWali,
        kecamatan_wali: KecamatanWali,
        kelurahan_wali: KelurahanWali,
        desa_wali: DesaWali,
        namaJalan_wali: NamaJalanWali,
        nama_club: NamaClub,
                ...
                {activeTab === "data-prestasi" && (
                  <div>
                    <div className="container">
                      ...
                      <div className="field is-full is-justify-content-space-between is-flex column">
                        <label className="">Nama Klub / Tim</label>
                        <div className="control">
                          <input
                            className="input is-small"
                            value={NamaClub}
                      ...
                      <div className="field is-full is-justify-content-space-between is-flex column">
                        <label className="">Nama Event</label>
                        <div className="control">
                          <input
                            className="input is-small"
                            value={NamaEvent}
                      ...
                      <div className="field is-full is-justify-content-space-between is-flex column">
                        <label className="">Prestasi Yang Dicapai</label>
                        <div className="control">
                          <select
                            className="is-small input "
                            value={Pencapaian}
