  ...
  return (
    <div>
      ...
      {user && user.role === "Atlet" && (
        <Link className='button ml-3 is-success'
          to={`/cabor/atlet/${
            atlets && atlets.Cabor && atlets.Cabor.id_cabor
          }/${atlets && atlets.uuid}?perkembangan-latihan?id=${
            atlets && atlets.id_atlet
          }`}
        >Perkembangan Latihan</Link>
      )}
      <div className="card">
          ...
          <div className="column content">
            ...
            {showAll && (
              <div className="">
                ...
                <div className="is-flex is-justify-content-space-between">
                  <div className="isi">
                    <label className="label mt-3">Pendidikan Formal</label>
                  ...
                  <div className="isi">
                    <label className="label mt-3">Perlengkapan (Outfit)</label>
                    <div className="is-flex">
                      <div className="field mr-5">
                        <p>Ukuran Baju</p>
                        <p>Ukuran Sepatu</p>
                ...
                <div className="isi">
                  <label className="label mt-3">Data Orang Tua Atlet</label>
                  <div className="is-flex is-justify-content-space-between">
                    <div className="isi">
                      <p>Data Ayah</p>
                      <div className="is-flex">
