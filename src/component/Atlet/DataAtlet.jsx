      ...
      <div className="is-flex">
        ...
        {user && user.role === "Admin" && (
          <div className="is-flex is-justify-content-space-between">
            <Link
              className="button ml-3 is-success mr-3 is-hidden-mobile"
              to={`/cabor/atlet/${
            ...
            <Link
              className="button ml-3 is-hidden-desktop is-success mr-3"
              to={`/cabor/atlet/${
                atlets && atlets.Cabor && atlets.Cabor.id_cabor
              }/${atlets && atlets.uuid}/tambah-perkembangan-latihan/${
                atlets && atlets.id_atlet
            ...
            <Link
              className="button is-success is-hidden-mobile"
              onClick={() => bukaModal(atlets && atlets.id_atlet)}
            >
              Tambah Prestasi
            </Link>
            <Link
              className="button is-success is-hidden-desktop"
              onClick={() => bukaModal(atlets && atlets.id_atlet)}
            >
              <IoAdd/> Prestasi
            </Link>
